...
wordup-cli/0.2.7 darwin-x64 node-v10.15.0
$ wordup --help [COMMAND]
USAGE
  $ wordup COMMAND
...
...
_See code: [src/commands/export.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/export.js)_
...
_See code: [src/commands/init.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/init.js)_
...
_See code: [src/commands/install.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/install.js)_
...
_See code: [src/commands/list.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/list.js)_
...
_See code: [src/commands/start.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/start.js)_
...
_See code: [src/commands/stop.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/stop.js)_
...
_See code: [src/commands/wpcli.js](https://github.com/wordup-dev/wordup-cli/blob/v0.2.7/src/commands/wpcli.js)_
<!-- commandsstop -->
